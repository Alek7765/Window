...
const changeModalState = state => {
  ...
  (0,_checkNumbInputs__WEBPACK_IMPORTED_MODULE_0__["default"])('#width');
  (0,_checkNumbInputs__WEBPACK_IMPORTED_MODULE_0__["default"])('#height');
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (checkNumbInputs);
...
const forms = state => {
  ...
  (0,_checkNumbInputs__WEBPACK_IMPORTED_MODULE_0__["default"])('input[name="user_phone"]');
  const message = {
    loading: 'Загрузка...',
...
const modals = () => {
  ...
  function calcScroll() {
    // ф-ция для подсчета ск px от скролла
...
const tabs = (headerSelector, tabSelector, contentSelecor, activeClass, display = 'block') => {
  ...
  header.addEventListener('click', e => {
    ...
    // проверяем нужный клас, убираем "." из наз-я класса
    target.parentNode.classList.contains(tabSelector.replace(/\./, "")))) {
      //проверяем тоже самое, только у родителя элемента
      tab.forEach((item, i) => {
...
const timer = (id, deadline) => {
  ...
  const getTimeRemaining = endtime => {
    const t = Date.parse(endtime) - Date.parse(new Date()),
      // дата окончания акции минус тек. дата
      seconds = Math.floor(t / 1000 % 60),
      // получаем количество оставшихся сек
      minutes = Math.floor(t / 1000 / 60 % 60),
      // получ кол-во оставших мин
      hours = Math.floor(t / (1000 * 60 * 60) % 24),
      // получ кол-во ост часов 
      days = Math.floor(t / (1000 * 60 * 60 * 24)); // получ кол-во ост дней

    return {
      // возвращаем объект с св-ми оставшихся дней, часов, минут, сек и общее время
      'total': t,
      'days': days,
      'hours': hours,
      'minutes': minutes,
